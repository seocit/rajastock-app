<x-modal name="create-supplier" title="Create Supplier" subtitle="Make sure your input data is valid">  
    <flux:input wire:model="supplier_code" label="Code *" placeholder="Supplier code" required/>
    <flux:input wire:model="supplier_name" label="Name *" placeholder="Supplier name" required/>  
