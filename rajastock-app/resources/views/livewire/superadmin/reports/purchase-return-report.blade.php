<div class="p-4">
    ...
    <flux:heading size="xl" level="1">Laporan Purchase Return</flux:heading>
    ...
    <div class="flex flex-wrap items-end gap-3 mb-4">
        ...
        <div class="flex flex-col">
            ...
            <select wire:model.live.debounce.300="printMode" class="border p-2 rounded w-48">
    ...
    <div class="overflow-x-auto bg-white shadow rounded-lg">
        <table class="min-w-full border border-gray-200 text-sm">
            ...
            @forelse ($this->returns as $r)
                ...
                @if ($printMode === 'summary')
                    <tr class="border-b">
                        <td class="px-3 py-2">{{ $r->return_number }}</td>
                        <td class="px-3 py-2">
            ...
            @empty
                <tr>
                    <td colspan="6" class="text-center py-4 text-gray-500">
                        Tidak ada data purchase return
                    </td>
                </tr>
            @endforelse
            </tbody>
