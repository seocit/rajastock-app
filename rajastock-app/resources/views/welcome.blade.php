...
<head>
    ...
    <title>Raja Stock</title>

    <link rel="icon" href="/images/RajaStock.png" sizes="any">
    <link rel="icon" href="/images/RajaStock.png" type="image/svg+xml">
...
<body class="h-screen w-screen">
    ...
    <!-- Link Google Fonts di head -->

    <div class="relative h-screen w-screen bg-cover bg-center"
        style="background-image: url('/images/frontPage.jpg'); font-family: 'Inter', sans-serif;">
        <!-- Overlay gelap + blur -->
        <div
            class="absolute inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex flex-col items-center justify-center text-center px-4 space-y-6">

            <!-- Nama Aplikasi dengan animasi fade-in -->
            <h1 class="text-white text-6xl font-bold drop-shadow-lg opacity-0 animate-fadeIn">RajaStock</h1>

            <!-- Tagline -->
            <p class="text-gray-200 text-xl drop-shadow-md opacity-0 animate-fadeIn delay-200">Sistem Manajemen Stok
                Terbaik</p>

            <!-- Tombol Login dengan hover efek -->
            <a href="/login"
                class="bg-yellow-500 hover:bg-yellow-600 hover:scale-105 transform transition duration-300 text-white font-semibold py-3 px-12 rounded-lg shadow-lg opacity-0 animate-fadeIn delay-400">
                Login
            </a>
